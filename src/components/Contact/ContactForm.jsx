  ...
  return (
    <div ref={secondRef} className="form-container">
      <div className="form-text">
        ...
        I'm actively seeking full-time opportunities — especially with companies tackling ambitious and meaningful projects.
However, if you have any other request or question, don’t hesitate to use the form below to get in touch.
📞 Mobile: +91 72498 18782
        </p>
